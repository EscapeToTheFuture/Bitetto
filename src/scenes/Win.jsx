...
const Win = ({reason}) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-[url(../images/bg-end.webp)] bg-center bg-clip-border bg-cover bg-origin-border bg-no-repeat">
